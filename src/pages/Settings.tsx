...
import { Settings as SettingsIcon, RefreshCw, Brain, Trash2, RotateCcw, ChevronDown, ChevronUp, MessageCircle, CheckCircle2, Unlink } from "lucide-react";
...
export default function SettingsPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 max-w-2xl">
      <CursorTooltip content="Manage app settings and integrations.">
        <div>
